<template>
    ...
    <div class="line-B">
        <div  class="ddown-B">
        <div class="ddown-select-B">
      <span class="slct-B">CUVETTE DE WC SUSPENDUE</span>
    </div>
