<template>
  ...
  <div class="qt1-batch-mod">
        <label>QUANTITÉ</label>
        <input type="text" placeholder="2000" required v-model="quantite1">
        </div>
        <div  class="ddown2-batch-mod">
        <div class="ddown-select2-batch-mod">
      <span class="slct2-batch-mod">LAVABO MURAL</span>
      <img @click="openModal2()" class="ddown-icon2-batch-mod" src="data:image/svg+xml;base64," />
    </div>
      <ul id="blcks2-batch-mod" class="blc-link2-batch-mod">
        <li>
          <a @click="filterClient($event)">AMINE KOUZMANE</a>
        </li>
        <li>
  ...
  <div class="qt2-batch-mod">
        <input type="text" placeholder="2000" required v-model="quantite2">
        </div>
        <div  class="ddown3-batch-mod">
        <div class="ddown-select3-batch-mod">
      <span class="slct3-batch-mod">LAVE MAIN ETNA</span>
      <img @click="openModal3()" class="ddown-icon3-batch-mod" src="data:image/svg+xml;base64," />
    </div>
      <ul id="blcks3-batch-mod" class="blc-link3-batch-mod">
        <li>
          <a @click="filterClient($event)">AMINE KOUZMANE</a>
        </li>
        <li>
...
.blc-link2-batch-mod {
 ...
 .blc-link2-batch-mod li  {
   padding: 5px 0;
   text-align: left;
   padding-top: 13px;
    padding-bottom: 13px;
 }
 .blc-link2-batch-mod a {
   font-size: 16px;
   color: #006D77;
   margin-right: 361px;
   text-decoration: none;
...
.blc-link3-batch-mod {
 ...
 .blc-link3-batch-mod li  {
   padding: 5px 0;
   text-align: left;
   padding-top: 13px;
    padding-bottom: 13px;
 }
 .blc-link3-batch-mod a {
   font-size: 16px;
   color: #006D77;
   margin-right: 5px;
   text-decoration: none;
